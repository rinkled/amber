...
func (o SitesChannels) MarshalJSON() ([]byte, error) {
...
type NullableSitesChannels struct {
	value *SitesChannels
	isSet bool
}

func (v NullableSitesChannels) Get() *SitesChannels {
	return v.value
}

func (v *NullableSitesChannels) Set(val *SitesChannels) {
	v.value = val
	v.isSet = true
}

func (v NullableSitesChannels) IsSet() bool {
	return v.isSet
}

func (v *NullableSitesChannels) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSitesChannels(val *SitesChannels) *NullableSitesChannels {
	return &NullableSitesChannels{value: val, isSet: true}
}

func (v NullableSitesChannels) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSitesChannels) UnmarshalJSON(src []byte) error {
	v.isSet = true
